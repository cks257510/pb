      ...
      <section class="panel-card">
        <div class="section-title-row">
          <div>
            ...
            <p class="section-caption" style="font-size:1.08em;">${tr('각 던전에서는 랜덤포켓몬, 보스포켓몬이 등장합니다.','Dungeons use the same battle screen and battle system as league battles. Each dungeon has 1 random enemy and 1 boss appearing in sequence.')}</p>
          </div>
